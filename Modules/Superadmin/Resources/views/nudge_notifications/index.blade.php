        ...
        <div class="row">
            <div class="col-md-8 text-white p-t-40 p-b-90">
                <h4 class="">
                    ...
                    <i class="mdi mdi-counter"></i></span> Chat Groups
                </h4>
            </div>
            <div class="col-md-4 text-right p-t-40 p-b-90">
                <button class="btn btn-md btn-primary btn-add-category" data-toggle="modal" data-target="#notificationmodel" data-route="{{ route('sa.nudge_notifications.create')}}" type="button"><i class="mdi mdi-plus"></i>Add Notification</button>
            </div>
        </div>
    </div>
</div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" data-category_id="{{$notification->id()}}" 
                                            data-url="{{route('sa.nudge_notifications.edit',[$notification->id()])}}" 
                                        ...
                                        <button class="btn btn-sm btn-danger record-delete" 
                                            type="button"
                                            data-url="{{route('sa.nudge_notifications.destroy', @$notification->id())}}" 
                                            data-redirect="{{route('sa.nudge_notifications.index')}}" 
                                            title="Delete">
...
@endsection
@php
$create_route = route('sa.nudge_notifications.create');
@endphp
