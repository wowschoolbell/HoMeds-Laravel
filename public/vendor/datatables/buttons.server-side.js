(function ($, DataTable) {
    ...
    DataTable.ext.buttons.export = {
        ...
        text: function (dt) {
            return '<i class="mdi mdi-download"></i> ' + dt.i18n('buttons.export', 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: function (dt) {
            return '<i class="mdi mdi-loop"></i> ' + dt.i18n('buttons.reset', 'Reset');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: function (dt) {
            return '<i class="mdi mdi-reload"></i> ' + dt.i18n('buttons.reload', 'Reload');
        },
