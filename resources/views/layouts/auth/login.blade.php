...
<main class="admin-main">
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="row align-items-center m-h-100">
                    <div class="mx-auto col-md-8">
                        <div class="p-b-20 text-center">
                            <p>
                                <img src="{{ asset('theme/light/img/vpslogo.png') }}" width="80" alt="">
                            </p>
            ...
            <div class="col-lg-8 d-none d-md-block bg-cover" style="background-image: url('theme/light/img/home.jpg'); background-size: contain;">
            </div>
        </div>
    </div>
</main>
