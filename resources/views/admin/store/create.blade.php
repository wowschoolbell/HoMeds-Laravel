                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                             ...
                                             <div class="form-group col-md-4">
                                                ...
                                                {{ Form::select('delivery_partner[app_statuses_id]', ["HoMeds"=>"HoMeds","White_Label"=>"White Label"], @$model['category']->status, ['class' => 'form-control  select2-wos', 'placeholder'=>'Select Status']) }}
                                            </div>
